...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    const getStats = async () => {
      const pageStatRequest = await fetch(`https://lal.goatcounter.com/counter/${pagePath}.json?start=${startDateString}`);
    ...
    <div className="footer-content">
      ...
      <ul className="footer-links">
        <li className="here">
          ...
          <Link color={Palette.art} href="/">louis-andre.net</Link>
        </li>
        <li className="work">
          <span style={{color: Palette.art}}>Work</span>
          <Link color={Palette.art} href="https://petiterevolte.com">petiterevolte.com</Link>
        </li>
        <li className="bluesky">
          <span style={{color: Palette.journal}}>Bluesky</span>
          <Link color={Palette.journal} href="https://bsky.app/profile/louis-andre.net">@louis-andre.net</Link>
        </li>
        <li className="mastodon">
          <span style={{color: Palette.journal}}>Mastodon</span>
          <Link color={Palette.journal} href="https://social.lol/@lalabadie">lalabadie@social.lol</Link>
        </li>
        <li className="visits">
          <span style={{color: Palette.externalLink}}>Visits</span>
          <Link color={Palette.externalLink} href="https://lal.goatcounter.com">
            {statCount == -1 ? "lal.goatcounter.com" : `${statCount} on this page`}
          </Link>
        </li>
      </ul>
    </div>
