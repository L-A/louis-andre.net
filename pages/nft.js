...
const NFT = () => {
	return (
		<Layout pageTitle="About NFTs" description="Blockchain addresses and carbon offset policy for Louis-André Labadie's NFT artworks." canonicalUrl="https://louis-andre.net/nft">
			<h1>About NFTs</h1>
