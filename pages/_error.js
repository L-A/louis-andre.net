...
const T = Translate({
  en: {
    ...
    hint: <p>If you clicked on an article's link from an older site, there's a chance you might find what you want in the <Link legacyBehavior href="/journal"><a className="link blue dim">Journal</a></Link> section of my website.</p>
  },
  fr: {
    title: "Quat' cent quat'",
    subtitle: "Oh! Il semblerait qu'il n'y ait pas de page à cette adresse sur le site.",
    hint: <p>Si vous avez cliqué sur un lien d'article, il y a des chances que vous trouviez ce que vous cherchez dans la section <Link legacyBehavior href="/journal"><a className="link blue dim">Journal</a></Link> du site.</p>
  }
})
