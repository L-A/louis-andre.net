...
const T = Translate({
  ...
  fr: {
    ...
    p_intro: "Mon travail consiste à prendre les idées larges et en faire des concepts bien définis, que je m’applique ensuite à réaliser.",
    ...
    p_work: 'J’ai appris et travaillé chez <a className="link dim blue" href="https://ock.am">Ockam</a>, <a className="link dim blue" href="https://mirego.com">Mirego</a>, et <a className="link dim blue" href="https://hooktstudios.com">Hookt Studios</a>. Accompagné des <em>tops</em> de l’industrie, j’y ai créé une multitude d’applications géniales, pour toutes sortes de gens et d’appareils.',
    p_tools: 'J’utilise des outils comme Photoshop, Illustrator, Sketch, Vim, un terminal, Javascript, SASS, différents <em>frameworks</em> et autres bidules de programmation selon les besoins du moment.'
  }
})
