...
export const meta = {
	title: "How to pick a starting palette for your web app",
	description:
		"An old guide I wrote for non-designers, to prevent getting stuck on picking base colors for a web app project",
	published: false,
	publishedDate: "2014"
}
...
![Here is how you manipulate HSB values in Bohemian Coding's Sketch app](/journal/web-app-palette/Picker.png)
...
![This blue, for example](/journal/web-app-palette/Palette-1.png)
...
![Nice, it's already a palette!](/journal/web-app-palette/Palette-2.png)
...
![Here's a decent secondary color, with a lighter variant. Nifty, huh?](/journal/web-app-palette/Palette-3.png)
...
![Here's a decent example](/journal/web-app-palette/Palette-4-1.png)
...
![Here's a horrible example](/journal/web-app-palette/Palette-5.png)
