...
<h2 style={{color: "#711BDE"}}>~ Please note, this guide is a bit outdated ~</h2>
...
![Make sure type is in points, and screen resolution is either 72 or 144 dpi](/journal/retina-photoshop/Unit-settings-1.png)
...
![Don't forget to set your dimensions in points instead of pixels](/journal/retina-photoshop/New-document-resolution.png)
...
![Wham! Be sure to do it in the right order](/journal/retina-photoshop/Convert-settings.png)
