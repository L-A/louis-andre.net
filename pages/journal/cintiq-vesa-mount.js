...
export default () => (
	<BlogPost title="VESA mounting a 13 inch Cintiq" titleColor="#4582c0" postMarkdown={postContent}>
		<small className="db lh-copy code gray f6">Published in December 2016</small>
		<video className="fr w-100 mw5-ns w-50-m mv3 mr0 ml4 ml5-l" src="http://i.imgur.com/uxG19u0.mp4" autoPlay loop></video>
	</BlogPost>
)
...
![A worthy offering to the VESA gods](/static/images/cintiq-vesa-mount/1-cut-tabs.jpg)

Fold each flap around 90°, and use a sharp blade to cut in the crease. The plastic is supple and will come off easily.
...
![Measure twice, mark with confidence](/static/images/cintiq-vesa-mount/2-mark-holes.jpg)
...
![No more sacrifices after that](/static/images/cintiq-vesa-mount/3-drill-holes.jpg)
...
![Thumb screws are a really nice attention](/static/images/cintiq-vesa-mount/place-stand-1.jpg)

![Clearance is much easier to get than FBI movies make it out to be](/static/images/cintiq-vesa-mount/place-stand-2.jpg)
...
![The thin nuts mean no contact between your mounting hardware and the Cintiq itself](/static/images/cintiq-vesa-mount/place-stand-3.jpg)
